...
const appCss = "/assets/styles-BmuFum6p.css";
...
const $$splitComponentImporter = () => import("./index-J6vyRNxk.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Premium structural engineering for industrial, commercial, and residential developments. 25+ years, 300+ projects, 10M+ sq.ft designed across India."
    }, {
      property: "og:title",
      content: "ISAAC Structural Consultancy"
    }, {
      property: "og:description",
      content: "Structural engineering excellence — RCC, PEB, post-tension. Chennai, India."
    }, {
      property: "og:type",
      content: "website"
    }, {
